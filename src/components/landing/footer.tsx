...
export default function Footer() {
  return (
    <footer className="overflow-hidden rounded-t-3xl bg-[var(--color-landing-surface)] px-6 pt-10">
      <Container>
        ...
        <p className="text-landing-fade-vertical -mb-6 select-none text-center text-[19vw] font-medium leading-[0.85] tracking-tight sm:text-[9rem]">
          Tecknode
        </p>
      </Container>
    </footer>
