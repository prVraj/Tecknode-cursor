        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3">
          {steps.map((step, i) => (
            <Reveal key={step.title} delay={i * 120}>
              <div className="h-full rounded-2xl border border-white/10 bg-[var(--color-landing-surface)] p-8 transition-colors hover:border-white/20">
                ...
                <p className="mt-3 text-sm leading-relaxed text-[var(--color-landing-muted)]">
                  {step.description}
                </p>
              </div>
            </Reveal>
