...
import dp from "@/assets/landing/testimonials/dp.png";
import person01 from "@/assets/landing/testimonials/person-01.png";
import person02 from "@/assets/landing/testimonials/person-02.png";
import person03 from "@/assets/landing/testimonials/person-03.png";
import person04 from "@/assets/landing/testimonials/person-04.png";
import person05 from "@/assets/landing/testimonials/person-05.png";
import person06 from "@/assets/landing/testimonials/person-06.png";
...
function TestimonialCard({ t }: { t: (typeof testimonials)[number] }) {
  return (
    <div className="flex h-full w-[22rem] shrink-0 flex-col justify-between rounded-2xl border border-white/10 bg-[var(--color-landing-surface)] p-6">
      ...
      <div className="mt-6 flex items-center gap-3">
        <div className="flex items-center">
          ...
          <div className="relative -ml-3 h-9 w-9 overflow-hidden rounded-full border-2 border-[var(--color-landing-surface)]">
            <Image src={t.photo} alt={t.name} fill sizes="36px" className="object-cover" />
          </div>
        </div>
        <div>
          <p className="text-sm font-semibold text-white">{t.name}</p>
          <p className="text-xs text-[var(--color-landing-muted)]">{t.role}</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <section className="border-t border-white/5 py-24">
        ...
        <Reveal>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-6 flex flex-col items-center">
              ...
              <p className="text-sm text-[var(--color-landing-muted)]">{featured.role}</p>
            </div>
          </div>
        </Reveal>
      </Container>
      ...
      <Reveal delay={100}>
        ...
        >
          <div className="flex w-max animate-landing-marquee gap-6">
            {row.map((t, i) => (
