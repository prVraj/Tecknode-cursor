  ...
  return (
    <section id="top" className="relative overflow-hidden pt-40 pb-24 md:pt-48 md:pb-32">
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className="animate-float pointer-events-none absolute -top-4 right-[8%] hidden w-40 opacity-80 drop-shadow-[0_20px_40px_rgba(139,92,246,0.35)] sm:block md:right-[14%] md:w-56"
      />
